package com.qinweizhao.generator.datasource;

import com.baomidou.dynamic.datasource.DynamicRoutingDataSource;
import com.baomidou.dynamic.datasource.creator.DefaultDataSourceCreator;
import com.baomidou.dynamic.datasource.spring.boot.autoconfigure.DataSourceProperty;
import com.baomidou.mybatisplus.annotation.DbType;
import com.qinweizhao.generator.util.DbTypeUtils;
...
public class DynamicDataSourceHelper {
    ...
    public boolean isErrorDataSourceProperty(DataSourceProperty dataSourceProperty) {
        try {
            Connection ignored = DriverManager.getConnection(dataSourceProperty.getUrl(),
